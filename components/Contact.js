...
const Contact = () => (
    ...
    >
        ...
        <p className="flex justify-center items-center">
            ...
            <a className="links px-[0.5%]" href="https://github.com/Lishen99" target="_blank"><Image className="zoom" src={`Lishen-Amaraweera-Resume/icons/github.png`} width={30} height={30} alt="GitHub"/></a>
